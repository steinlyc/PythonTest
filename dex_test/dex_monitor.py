...
local_formatstrftime = datetime.datetime.strftime(local_time, '%Y-%m-%d %H:%M:%S')
local_formatstrptime = datetime.datetime.strptime(local_formatstrftime, '%Y-%m-%d %H:%M:%S')
